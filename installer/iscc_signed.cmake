...
execute_process(
  COMMAND ${ISCC} /DAppVersion=${VERSION} /DOutputBaseFilename=${SETUP_EXE} /DSrcDir=Output/portable_signed/teraterm /O${SETUP_DIR} ${CMAKE_CURRENT_LIST_DIR}/teraterm.iss
